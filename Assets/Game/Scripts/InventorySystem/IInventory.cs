...
namespace Game.Scripts.InventorySystem
{
    ...
    public static class InventoryExt
    {
        ...
        public static int CountItems(this IInventory inventory, ItemConfig item)
        {
            var count = 0;
        ...
        public static int Available(this IInventory inventory, ItemConfig item)
        {
            var available = 0;
        ...
        public static int Pick(this IInventory inventory, ItemConfig item, int amount = 1)
        {
        ...
        public static int Put(this IInventory inventory, ItemConfig item, int amount = 1)
        {
            if (amount <= 0) return 0;
        ...
        public static bool CanPick(this IInventory inventory, ItemConfig item, int amount = 1)
        {
        ...
        public static bool CanPut(this IInventory inventory, ItemConfig item, int amount = 1)
        {
            if (amount <= 0) return false;
        ...
        public static bool TryPick(this IInventory inventory, ItemConfig item, int amount = 1)
        {
        ...
        public static bool TryPut(this IInventory inventory, ItemConfig item, int amount = 1)
        {
        ...
        public static IEnumerable<ItemConfig> GetItems(this IInventory inventory)
        {
        ...
        public static bool TryPickItem(this IInventory inventory, out ItemConfig item)
        {
            for (var i = inventory.CountSlots - 1; i >=0 ; i--)
            {
                var slot = inventory.GetSlot(i);
